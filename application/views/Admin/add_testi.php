          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Here you can Add testimonial </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              
              <form action="<?=base_url('/').'Testi_controller/add_testimonial'?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="exampleInputEmail1" rows="10" cols="30" name="title" placeholder="Enter Descripion"></textarea>
                  </div>
                  <div class="form-group">
